...
fn print_help() {
    ...
    println!(
        "  Qwen3.8 NVFP4: --qwen38-nvfp4 ABSOLUTE_DIRECTORY [--mtp-weights ABSOLUTE_SIDECAR_DIRECTORY] [--mtp-draft-width 0|2|3|4] (MTP default: reviewed .sllm/mtp-nvfp4-v1; width 2)"
    );
    println!(
