...
- 技術的要点はreaderとして抽出し、llama.cpp以外のengineのcodeをimplementerへ直接渡したり、uLLMへcopy・adapt・portしたりしない。llama.cppの直接reuseは `docs/provenance/README.md` の記録・notice processに従う。
