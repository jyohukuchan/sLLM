...
- 次:
  ...
  2. Stage E E0 host draftは完了した。次はE1としてexact `gfx1030` CLIをcanonical V620で最小prompt・1 generated tokenから実行し、full-model D1 loweringのruntime defectを修正する。V620 PASS前にR9700へ広げない。
