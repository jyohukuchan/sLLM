...
#define SLLM_HIP_RMSNORM_MAX_N UINT64_C(5120)
...
#define SLLM_HIP_RESIDUAL_RMSNORM_KERNEL_ID_PREQUANT_FP8_V1 UINT32_C(3)
#define SLLM_HIP_RESIDUAL_RMSNORM_KERNEL_ID_PREQUANT_NVFP4_V1 UINT32_C(4)
...
#define SLLM_HIP_ELEMENTWISE_KERNEL_ID_SILU_MUL_PREQUANT_FP8_V1 UINT32_C(10)
#define SLLM_HIP_ELEMENTWISE_KERNEL_ID_SILU_MUL_PREQUANT_NVFP4_V1 UINT32_C(11)
#define SLLM_HIP_ELEMENTWISE_KERNEL_ID_SIGMOID_MUL_PREQUANT_FP8_V1 UINT32_C(12)
...
#define SLLM_HIP_EMBEDDING_MAX_HIDDEN UINT64_C(5120)
...
#define SLLM_HIP_MATMUL_KERNEL_ID_FP8_OUTER_GFX1201_DOT4_V1 UINT32_C(103)
...
#define SLLM_HIP_MATMUL_MAX_K UINT64_C(17408)
...
/* Fixed K20 with a sorted local-row to global-vocabulary map stored after
 * the selector scratch region in workspace. */
#define SLLM_HIP_TOKEN_SELECTOR_VERSION_FIXED_TOPK_TOPP_MAPPED UINT32_C(3)
...
#define SLLM_HIP_TOKEN_SELECTOR_FLAG_VOCAB_MAP_PRESENT UINT32_C(4)
