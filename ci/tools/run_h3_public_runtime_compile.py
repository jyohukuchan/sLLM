...
PUBLIC_RUNTIME_API_SOURCE_PATHS = (
    ...
    "native/lowp/src/lowp_plan.cpp",
    "native/lowp/src/lowp_launch.cpp",
...
PUBLIC_RUNTIME_KERNEL_SOURCE_PATHS = (
    ...
    "native/hip/src/row_concat_kernel.hip.cpp",
    "native/hip/src/token_selector_kernel.hip.cpp",
    "native/hip/src/token_selector_pq_kernel.hip.cpp",
)
PUBLIC_RUNTIME_DIRECT_INCLUDE_PATHS = (
    ...
    "native/hip/src/graph_span_runtime.inc",
    ...
    "native/lowp/include/lowp/detail/low_precision_matmul_provider.hpp",
    "native/lowp/include/lowp/detail/lowp_api_internal.hpp",
    "native/lowp/include/lowp/detail/bf16_helpers.inc",
    "native/lowp/include/lowp/detail/lowp_provider_plan.hpp",
    "native/lowp/include/lowp/lowp.h",
    "native/hip/src/matmul_api.hpp",
    "native/hip/src/matmul_kernel_internal.hpp",
    "native/lowp/include/lowp/detail/lowp_kernel_internal.hpp",
    "native/hip/src/matmul_runtime.inc",
    "native/lowp/src/fp8_prefill_short_m32.inc",
    "native/lowp/src/nvfp4_decode_scale_lut.inc",
    "native/lowp/src/nvfp4_prefill_wmma_compensated.inc",
    "native/lowp/src/nvfp4_small_m_vgpr_reuse.inc",
    ...
    "native/hip/src/row_concat_internal.hpp",
    "native/hip/src/row_concat_runtime.inc",
    "native/hip/src/token_selector_api.hpp",
    "native/hip/src/token_selector_kernel_internal.hpp",
    "native/hip/src/token_selector_pq_algorithm.hpp",
    "native/hip/src/token_selector_pq_internal.hpp",
    "native/hip/src/token_selector_pq_runtime.inc",
    "native/hip/src/token_selector_runtime.inc",
    "native/hip/src/token_selector_support_internal.hpp",
...
PUBLIC_SYMBOLS = tuple(sorted({
    ...
    "sllm_buffer_size", "sllm_causal_attention_execute", "sllm_causal_attention_execute_after_kv_append", "sllm_completion_finalize_after",
    ...
    "sllm_get_abi_version", "sllm_graph_span_create", "sllm_graph_span_execute", "sllm_graph_span_node_count", "sllm_graph_span_release", "sllm_kv_state_append", "sllm_kv_state_append_cancel",
    "sllm_kv_state_create", "sllm_kv_state_create_v2", "sllm_kv_state_export",
    "sllm_kv_state_create_paged", "sllm_kv_state_fork_paged", "sllm_kv_state_fork_query_paged",
    "sllm_kv_state_paged_image_export", "sllm_kv_state_paged_image_import",
    "sllm_kv_state_paged_image_import_finalize", "sllm_kv_state_paged_image_query",
    "sllm_kv_state_paged_image_section_size", "sllm_kv_state_query_paged", "sllm_kv_view_query_paged",
    ...
    "sllm_qwen38_projection_pack2_execute", "sllm_qwen38_projection_pack2_plan_release", "sllm_qwen38_projection_pack2_prepare", "sllm_query_version", "sllm_queue_create", "sllm_queue_fence",
...
# Explicit device-kernel symbols emitted by the HIP implementation.  This inventory is
...
KERNEL_SYMBOLS = (
    ...
    "sllm_gemma4_moe_gateup_nvfp4_v2",
    "sllm_gemma4_moe_quantize_active_nvfp4_v2",
    ...
    "sllm_matmul_bf16_to_mxfp6_e3m2_block32_v1",
    "sllm_matmul_bf16_to_mxfp8_e4m3_block32_v1",
    ...
    "sllm_matmul_nvfp4_block16_to_fp16_staging_v1",
    "sllm_matmul_nvfp4_tensor_scale_epilogue_v1",
    ...
    "sllm_matmul_nvfp4_w4a4_decode_dp4a_wave4col32_lds_f32_lut_v1",
...
ADDITIONAL_DEVICE_STUB_SYMBOLS = (
    "_ZN27sllm_ministral3_yarn_kernel12_GLOBAL__N_137__device_stub__ministral3_yarn_kernelEPKtS2_PKiPtS5_jjjb",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj0EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj1EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj2EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj3EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj7EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb0ELj9EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj0EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj1EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj2EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj3EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj7EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_138__device_stub__causal_attention_kernelILb1ELj9EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmmmjjjffmf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_144__device_stub__scaled_prefill_combine_kernelILj0EEEvPfPKfPKtS6_PKmPKvSA_S4_jjmmjjjjf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_144__device_stub__scaled_prefill_combine_kernelILj6EEEvPfPKfPKtS6_PKmPKvSA_S4_jjmmjjjjf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_144__device_stub__scaled_prefill_pack_kv_kernelILj0EEEvPKvS3_S3_S3_PKfS5_PtS6_Pmmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_144__device_stub__scaled_prefill_pack_kv_kernelILj6EEEvPKvS3_S3_S3_PKfS5_PtS6_Pmmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj0EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj1EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj2EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj3EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj7EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb0ELj9EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj0EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj1EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj2EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj3EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj7EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_156__device_stub__causal_attention_decode_wave_split_kernelILb1ELj9EEEvPKtPKvS5_S5_S5_PKfS7_Ptmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj0ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj0ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj1ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj1ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj2ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj2ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj3ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj3ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj6ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj6ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj7ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj7ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj8ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj8ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj9ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_qtile4_kernelILj9ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj0EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj1EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj2EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj3EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj7EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_gqa4_shared_kernelILj9EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_162__device_stub__causal_attention_prefill_gqa6_qtile8_w16_kernelILj6ELj6EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    ...
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_163__device_stub__causal_attention_prefill_gqa6_qtile4_fp16_kernelILj16EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_163__device_stub__causal_attention_prefill_gqa6_qtile4_fp16_kernelILj32EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_163__device_stub__causal_attention_prefill_gqa6_qtile4_fp16_kernelILj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_163__device_stub__causal_attention_prefill_gqa6_qtile4_fp16_kernelILj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_167__device_stub__causal_attention_decode_gqa6_split_p32_stage1_kernelEPKtS2_S2_PtmPf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_167__device_stub__causal_attention_decode_gqa6_split_p32_stage2_kernelEPKtPtjPKf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_167__device_stub__causal_attention_decode_gqa6_split_p64_stage1_kernelEPKtS2_S2_PtmPf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_167__device_stub__causal_attention_decode_gqa6_split_p64_stage2_kernelEPKtPtjPKf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_168__device_stub__causal_attention_decode_gqa6_split_p128_stage1_kernelEPKtS2_S2_PtmPf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_168__device_stub__causal_attention_decode_gqa6_split_p128_stage2_kernelEPKtPtjPKf",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_169__device_stub__causal_attention_prefill_gqa6_blocksoftmax_fp16_kernelILj32EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_169__device_stub__causal_attention_prefill_gqa6_blocksoftmax_fp16_kernelILj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_172__device_stub__causal_attention_prefill_gqa6_blocksoftmax_q8_fp16_kernelEPKtPKvS4_S4_S4_PKfS6_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel63__device_stub__causal_attention_gqa6_rocblas_softmax_f16_kernelEPtjmm",
    "_ZN28sllm_causal_attention_kernel63__device_stub__causal_attention_gqa6_rocblas_softmax_f32_kernelEPfjmm",
    "_ZN28sllm_causal_attention_kernel63__device_stub__causal_attention_gqa6_rocblas_unpack_bf16_kernelEPKfPtj",
    "_ZN28sllm_causal_attention_kernel66__device_stub__causal_attention_gqa6_rocblas_convert_kv_f32_kernelEPKtPfm",
    "_ZN28sllm_causal_attention_kernel66__device_stub__causal_attention_gqa6_rocblas_pack_query_f16_kernelEPKtPtj",
    "_ZN28sllm_causal_attention_kernel66__device_stub__causal_attention_gqa6_rocblas_pack_query_f32_kernelEPKtPfj",
)
...
def expected_build_commands() -> list[list[str]]:
    ...
    return [
        [
            "/opt/rocm/bin/amdclang++", "-D__HIP_ROCclr__=1", "-O3", "-ffp-contract=off", "-DNDEBUG", "-DSLLM_HIP_COMPILE_TARGET=\"{target}\"", "-DLOWP_COMPILED_TARGET=\"{target}\"", "-std=gnu++17",
            "-I", "{repo}/include", "-I", "{repo}/native/hip/src", "-I", "{repo}/native/lowp/include", "--offload-arch={target}",
        ...
        [
            "/opt/rocm/bin/amdclang++", "-O3", "-ffp-contract=off", "-DNDEBUG", "-DSLLM_HIP_COMPILE_TARGET=\"{target}\"", "-DLOWP_COMPILED_TARGET=\"{target}\"", "-std=gnu++17",
            "-I", "{repo}/include", "-I", "{repo}/native/hip/src", "-I", "{repo}/native/lowp/include", "--offload-arch={target}",
            "-mcode-object-version=6", "-mno-wavefrontsize64", "-pthread", "-o",
        ...
        [
            ...
            "-ffp-contract=off", "-D__HIP_ROCclr__=1", "-D__HIP_PLATFORM_AMD__", "-DSLLM_HIP_COMPILE_TARGET=\"{target}\"", "-DLOWP_COMPILED_TARGET=\"{target}\"", "-std=gnu++17", "-I", "{repo}/include", "-I", "{repo}/native/hip/src", "-I", "{repo}/native/lowp/include", "-I", "/opt/rocm/include",
            "-x", "c++",
...
def run_commands(
    ...
    *,
    ...
    steps = step_results if step_results is not None else []
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        run_commands(commands, row, repo, env, pass_fds=(build_fd,), step_results=steps)
