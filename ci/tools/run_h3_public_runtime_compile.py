...
KERNEL_SYMBOLS = (
    ...
    "sllm_matmul_fp8_e4m3fn_to_fp16_staging_v1",
    ...
    "sllm_matmul_fp8_outer_f16scale_epilogue_v1",
    ...
    "sllm_matmul_nvfp4_block16_to_fp8_staging_v1",
    "sllm_matmul_nvfp4_tensor_scale_epilogue_v1",
    "sllm_matmul_nvfp4_tensor_scale_product_v1",
...
ADDITIONAL_DEVICE_STUB_SYMBOLS = (
    ...
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_typed_tiled_kernelILj0ELj4ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_typed_tiled_kernelILj0ELj4ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_typed_tiled_kernelILj0ELj8ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_typed_tiled_kernelILj6ELj4ELj4EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_typed_tiled_kernelILj6ELj4ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
    "_ZN28sllm_causal_attention_kernel12_GLOBAL__N_158__device_stub__causal_attention_prefill_typed_tiled_kernelILj6ELj8ELj8EEEvPKtPKvS5_S5_S5_PKfS7_Ptjmjjjff",
...
def expected_build_commands() -> list[list[str]]:
    ...
    return [
        [
            "/opt/rocm/bin/amdclang++", "-D__HIP_ROCclr__=1", "-O3", "-DNDEBUG", "-DSLLM_HIP_COMPILE_TARGET=\"{target}\"", "-std=gnu++17",
        ...
        [
            "/opt/rocm/bin/amdclang++", "-O3", "-DNDEBUG", "-DSLLM_HIP_COMPILE_TARGET=\"{target}\"", "-std=gnu++17",
            "-I", "{repo}/include", "-I", "{repo}/native/hip/src", "--offload-arch={target}",
            "-mcode-object-version=6", "-mno-wavefrontsize64", "-pthread", "-o",
        ...
        [
            ...
            "-D__HIP_ROCclr__=1", "-DSLLM_HIP_COMPILE_TARGET=\"{target}\"", "-std=gnu++17", "-I", "{repo}/include", "-I", "{repo}/native/hip/src",
            "-x", "c++",
...
def validate_matrix(repo: Path) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    if matrix.get("schema_version") != "hip-runtime-compile-v1" or matrix.get("matrix_id") != "hip-runtime-compile-v1" or matrix.get("revision") != 12:
