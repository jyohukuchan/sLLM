#!/usr/bin/env python3
"""Extract the exact SQ8_0 HIPRTC raw literal for offline ISA compilation."""
...
def main() -> int:
    ...
    try:
        ...
        raise SystemExit("could not locate the SQ8_0 HIPRTC raw literal") from exc
    kernel_source = source[start:end]
    if "ullm_sq_fp8_matvec_f32_kernel" not in kernel_source:
        raise SystemExit("extracted source does not contain the SQ8_0 matvec kernel")
