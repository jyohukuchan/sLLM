...
# Keep a failed or interrupted window immutable; a retry supplies a fresh
# directory through ULLM_SQ8_ADAPTIVE_OUTPUT_DIR.
out="${ULLM_SQ8_ADAPTIVE_OUTPUT_DIR:-$root/benchmarks/results/2026-07-27/prefill-adaptive-chunk}"
...
mkdir -p "$out"/{decode,generation,numerical,preflight,service,source,thermal,throughput}
