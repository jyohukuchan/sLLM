...
constexpr const char *kAdjacentLogicalKernelId =
    "ministral3.yarn_adjacent.bf16_fp32.qscale.v2";
constexpr const char *kAdjacentDeviceSymbol = "sllm_ministral3_yarn_bf16_v2";
...
hipError_t launch(const uint16_t *query, const uint16_t *key,
                  ...
                  uint32_t kv_heads, bool adjacent_pairing,
