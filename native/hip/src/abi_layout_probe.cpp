...
#define SLLM_PRINT_CONSTANT(name)                                              \
  ...
  SLLM_PRINT_CONSTANT(SLLM_TENSOR_DTYPE_F8_E5M2);
  ...
  SLLM_PRINT_CONSTANT(
      SLLM_HIP_KV_KERNEL_ID_BF16_TO_FP8_E4_BLOCK16_TOKEN_MAJOR_V1);
  SLLM_PRINT_CONSTANT(
      SLLM_HIP_KV_KERNEL_ID_BF16_TO_FP8_E5_BLOCK16_TOKEN_MAJOR_V1);
  SLLM_PRINT_CONSTANT(
  ...
  SLLM_PRINT_CONSTANT(SLLM_HIP_KV_ENCODING_FP8_E4_BLOCK16_V1);
  SLLM_PRINT_CONSTANT(SLLM_HIP_KV_ENCODING_FP8_E5_BLOCK16_V1);
  SLLM_PRINT_CONSTANT(SLLM_HIP_KV_ENCODING_FP8_E4_BLOCK16_V2);
  SLLM_PRINT_CONSTANT(SLLM_HIP_KV_ENCODING_FP8_E5_BLOCK16_V2);
  ...
  SLLM_PRINT_CONSTANT(SLLM_HIP_MATMUL_MXFP8_W8A8_VERSION);
  SLLM_PRINT_CONSTANT(SLLM_HIP_MATMUL_MXFP6_W6A6_VERSION);
  ...
  SLLM_PRINT_CONSTANT(SLLM_HIP_MATMUL_KERNEL_ID_MXFP8_W8A8_DECODE_V1);
  ...
  SLLM_PRINT_CONSTANT(SLLM_HIP_MINISTRAL3_YARN_ADJACENT_VERSION);
  ...
  SLLM_PRINT_CONSTANT(
      SLLM_HIP_MINISTRAL3_YARN_KERNEL_ID_BF16_ADJACENT_QSCALE_V2);
  ...
  SLLM_PRINT_CONSTANT(SLLM_TENSOR_ENCODING_FP8_BLOCK16_E8M0);
  SLLM_PRINT_CONSTANT(SLLM_TENSOR_ENCODING_MXFP8_BLOCK32_E8M0);
  SLLM_PRINT_CONSTANT(SLLM_TENSOR_ENCODING_MXFP6_E3M2_BLOCK32_E8M0);
