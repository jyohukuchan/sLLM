#ifndef SLLM_MINIMAX_M3_MOE_ROUTE_API_HPP
#define SLLM_MINIMAX_M3_MOE_ROUTE_API_HPP
...
sllm_status_t
validate_descriptor_prefix(const sllm_minimax_m3_moe_route_desc_t *descriptor,
                           sllm_error_sink_t *sink) noexcept;

sllm_status_t
validate_and_copy_descriptor(const sllm_minimax_m3_moe_route_desc_t *descriptor,
                             DescriptorMetadata *metadata,
                             sllm_error_sink_t *sink) noexcept;

sllm_status_t
validate_dispatch_info(const sllm_minimax_m3_moe_route_dispatch_info_t *info,
                       sllm_error_sink_t *sink) noexcept;
...
#endif // SLLM_MINIMAX_M3_MOE_ROUTE_API_HPP
